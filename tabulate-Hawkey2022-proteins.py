...
'''
tabulate-Hawkey2022-proteins.py by Rohan Maddamsetti.

This script tabulates all proteins in a strain that have multiple
identical copies across all chromosomes and plasmids.

Usage: python tabulate-Hawkey2022-proteins.py ## for tabulating all proteins

Usage: python tabulate-Hawkey2022-proteins.py --ignore-singletons ## for tabulating multi-copy proteins only
'''
...
if args.ignore_singletons:
    outf = "../results/Hawkey2022-duplicate-proteins.csv"
else:
    outf = "../results/Hawkey2022-all-proteins.csv"
print("outfile =>", outf)
    

inputdir = "../data/Hawkey2022-Hybrid-Assemblies-NCBI-BioProject-PRJNA646837/"

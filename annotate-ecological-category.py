...
animal_hosts = [
    ...
    "crow", "cassida sp.", "pelodiscus sinensis",
...
terrestrial_isolation_sources = [
    ...
    "moist arsenopyrite (feass)-containing rock taken from a mine tunnel approximately 300 m below the ground in the granites gold mine",
...
food_hosts = ["kimchi cabbage", "mung bean", "kombucha scoby", "seujeot",
...
food_isolation_sources = [
    ...
    "salad", "rotten eggs", "steamed conch",
...
anthropogenic_isolation_sources = [
    ...
    "in the nicotine environment", "outdoor built environment",
    ...
    "shelf","brewery environment", "lab strain",
...
na_isolation_sources = [
    "enviornmental","host's whole body","bacterial consortium", "missing",
    ...
    "r.j.roberts", "whole body", "atcc isolate",
    ...
    "laboratory strain derived from cip","local geographical source", "dsmz isolate",
    "air sacs","isolated from commercially available","contaminated wipes","protoplast breeding",
    "iam12617", "singapore", "jamiecosley",

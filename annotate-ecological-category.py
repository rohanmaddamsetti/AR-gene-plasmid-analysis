...
animal_hosts = [
    ...
    "drosophila melanogaster oregon", "allacta bimaculata", "peafowl",
    ...
    "odontobutis platycephala", "lutjanus guttatus (rose snapper)",
    ...
    "arctic char", "microlophium carnosum", "photinus pyralis",
    ...
    "draeculacephala minerva", "spodoptera frugiperda", "danaus plexippus",
    ...
    "drosophila neotestacea","shrimps", "bird of prey", "ardea cinerea",
    ...
    "meimuna kuroiwae", "tettigades ulnaria", "cystophora cristata",
...
terrestrial_isolation_sources = [
    ...
    "rock (ENVO:00001995)", "Geothermal Reservoir",
    ...
    "rifle well cd01 at 16ft depth; 0.2 micron filter at time point a",
...
agri_isolation_sources = [
    ...
    "noduls from roots of medicago sativa", "cilantro","rice root", "rice leaf",
    ...
    "white nectarines fire pearl variety", "soybean nodules"]
...
livestock_hosts = [
    ...
    "equus caballus ferus", "pork", "sus", "bubalus bubalis",
...
livestock_isolation_sources = [
    ...
    "heifer vaginal mucus", "cloaca", "buffalo calf",
    ...
    "bulk pig ears", "cattle slurry", "cow feces",
...
anthropogenic_isolation_sources = [
    ...
    "aquarium water", "biofilm sample", "medium",
    ...
    "anabaena culture", "dairy environment",
...
human_isolation_sources = [
    ...
    "perirectal swab", "rectal", "anal swab", "human skin tissue",

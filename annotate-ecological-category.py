...
animal_hosts = ["donacia thalassina", "ixodes persulcatus", "tegillarca granosa", "edessa sp.","nematode",
        ...
        "chroicocephalus novaehollandiae (australian silver","trachinotus ovatus", "shrimp", "crow",
...
animal_isolation_sources = ["animal", "wild rat", "coho salmon", "fruit fly","diaphorina citri", "iguana",
        ...
        "tilapia", "wild pig; fecal", "shellfish","diarrheal snake diarrheal snake in",
        ...
        "monkey kidney tissue-culture fluids of", "neophocaena phocaenoides", "loach","unidentified actinians", "fish",
...
plant_isolation_sources = ["flower of forsythia koreana", "algal phycosphere", "lotus corniculatus nodule",
                           ...
                           "inner tissues of halophyte limonium","leaf", "root nodule of sesbania cannabina",
                           "flower of rhododendron sclippenbachii", "base of single tree in sidewalk along"]
...
marine_isolation_sources = ["salt lake", "hydrothermal vent area derived", "deep sea", "water from the baltic sea",
        ...
        "culture of roseovarius sp. tm1035", "coastal","runway 10 reef (10-12 m)",
                            "microbial mat material from brackish", "hydrothermal precipitates", "shallow sea; symbiosis with algae",
...
anthropogenic_isolation_sources = ["surface of a polyethylene microplastic", "cleaning system aquaculture", "clam larvae aquaculture",
                                   "mineral salt medium", "high concentration of fluoride", "fish larvae aquaculture", "sewage water",
                                   "potash salt dump","bakery environment - hallway", "r2a medium", "polystyrene", "salt mine","bioreactor", "sewage & soil",
        ...
        "hot water tap; geest office building", "industrial building air scrubber",
        ...
        "chilean kraft-pulp mill effluents", "automobile air conditional evaporator", "sludge from bioreactor treating",
                                   "bakery environment - concentrated", "hospital sink", "oil-immersed sample from guaymas basin", "oil contaninated soil"]
...
human_isolation_sources = ["from patient with pneumonia", "blood", "stool","saliva","skin swab",
        ...
        "human skin swab","vomit from a food poisoning case","china: the first affiliated hospital of","sputum",
...
na_isolation_sources = ["envo:01001050","enviornmental","host's whole body","bacterial consortium","cell culture",
        "spring","afb-diseased colony","the bacterial strain was isolated from","environment swab",
        "biological fluid","not available: to be reported later","environment","r.j.roberts","hydrothermal fluid",
        "thiodendron' bacterial sulfur mat from","envo:00000227","atcc isolate","the pit mud of a chinese flavor",
        "envo:00002011","isolate obtained from atcc:7955 nca","kimoto","denitrifying; sulfide-oxidizing",
        "obscured","peter dedon mit","swab","probiotic preparation","dsm:3754","laboratory isolate","tsoundzou",
        "usa: wa: seattle","not available: to be reported later","not known","bone powder",
        "electroporation of y pestis kim6+ in","laboratory strain derived from cip","local geographical source",
        "air sacs","isolated from commercially available","contaminated wipes","protoplast breeding","iam12617",
        "enrichment cultures from ucc","commercial starter culture for","swab with brown-gray powder",
        "anaerobic environments","environmental","neb269","environmental swabs","high motility on swim plates;",
        "coconi","csf","balf","china: zibo; shandong","wild type strain isolated from a","poland; warsaw area","agr",
                        "Enviornmental"]
...
with open("../results/AR-gene-duplication/gbk-annotation-table.csv", "r") as annotation_fh:
    for i, line in enumerate(annotation_fh):
        ...
        # Marine
            ...
            annotation = "Marine"
        elif " sea " in isolation_source and "sediment" not in isolation_source and "mud" not in isolation_source:
            annotation = "Marine"
        elif "seawater" in isolation_source and host == "na":
            annotation = "Marine"
              ...
              and "sponge" not in isolation_source):
            annotation = "Marine"
        ...
        ## Freshwater
            ...
            annotation = "Freshwater"
              ...
              and "sea" not in isolation_source and "waste" not in isolation_source and "oil" not in isolation_source

...
'''
tabulate-Bhatt-proteins.py by Rohan Maddamsetti.

This script tabulates all proteins in a strain that have multiple
identical copies across all chromosomes and plasmids.

Usage: python tabulate-Bhatt-proteins.py ## for tabulating all proteins

Usage: python tabulate-Bhatt-proteins.py --ignore-singletons ## for tabulating multi-copy proteins only
'''
...
if args.ignore_singletons:
    outf = "../results/Bhatt-duplicate-proteins.csv"
else:
    outf = "../results/Bhatt-all-proteins.csv"
print("outfile =>", outf)
    

inputdir = "../data/Moss2020-LongRead-Assemblies-NCBI-BioProject-PRJNA508395/"

...
'''
tabulate-BARNARDS-proteins.py by Rohan Maddamsetti.

This script tabulates all proteins in a strain that have multiple
identical copies across all chromosomes and plasmids.

Usage: python tabulate-BARNARDS-proteins.py ## for tabulating all proteins

Usage: python tabulate-BARNARDS-proteins.py --ignore-singletons ## for tabulating multi-copy proteins only
'''
...
if args.ignore_singletons:
    outf = "../results/BARNARDS-duplicate-proteins.csv"
else:
    outf = "../results/BARNARDS-all-proteins.csv"
print("outfile =>", outf)
    

inputdir = "../data/BARNARDS-LongRead-Assemblies-NCBI-BioProject-PRJNA767644/"
